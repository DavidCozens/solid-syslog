...
SOLIDSYSLOG_STATIC_ASSERT(
    sizeof(struct freertos_sockaddr) <= SOLIDSYSLOG_ADDRESS_SIZE,
    SolidSyslogAddressStorage_too_small_for_freertos_sockaddr
);

static inline const struct freertos_sockaddr* SolidSyslogAddress_AsConstFreertosSockaddr(
