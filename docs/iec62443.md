...
|---|---|---|
| *All SL1 components* | | |
| `SolidSyslogStreamSender` | `SolidSyslogStreamSender.h` | Reliable octet-framed transport (RFC 6587) over a Stream — `SolidSyslogPosixTcpStream` at SL2, `SolidSyslogTlsStream` at SL4 |
